...
// @route   GET /api/pr-leads/:id/document-download
// @access  Private
router.get('/:id/document-download', protect, async (req, res) => {
  try {
    ...
    const filePath = await resolveStoredFileUrl(doc.filePath, 'pr-docs');
    ...
    console.error('PR document download error:', error);
